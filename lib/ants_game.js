...
class AntColony {
  ...
  get queenHasBees() {
      console.log(this._queenPlace.entrance);
...
class QueenPlace extends Place {
  ...
  get queenHasBees() {
    return this.colonyQueen.queenHasBees() || this.place.bees.length > 0;
  }
}
...
var Ants = {
  ...
  Queen : class extends Ant {
    ...
    act(colony) {
        var test = new QueenPlace(colony.queenPlace, this.place);
        colony.newQueenPlace(this.place);
        //console.log(colony.queenPlace);
